...
<section class="bg-hero bg-cover h-full w-full relative">
	<div class="w-full h-full flex items-center justify-center absolute top-0 z-20">
		<div class="flex flex-col">
			<p class="text-3xl md:text-5xl lg:text-6xl xl:text-8xl 2xl:text-9xl text-white font-semibold">
				Samithiwat Boonchai
			</p>
			<p class="text-sm md:text-lg lg:text-2xl xl:text-3xl 2xl:text-4xl text-gray-200 mx-auto">
				Backend Developer
			</p>
		</div>
	</div>
