...
<div
	class="bg-header bg-cover flex flex-col justify-center text-center font-MuseoModerno w-full h-52 sm:h-100 relative"
>
	...
	<span
		class="flex flex-wrap sm:flex-row justify-center my-3 sm:my-12 2xl:my-8 px-28 mobile-m:px-36 mobile-l:px-40 sm:px-20 gap-x-5 gap-y-2 sm:gap-x-20"
	>
		<a href="https://www.linkedin.com/in/samithiwat/" target="_blank" class="">
			<Icon
				icon="akar-icons:linkedin-fill"
				color="white"
				class="w-8 sm:w-20 2xl:w-24 h-8 sm:h-20 2xl:h-24"
			/>
		</a>
