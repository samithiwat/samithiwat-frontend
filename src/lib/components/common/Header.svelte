...
<div class="bg-headerBg text-center font-MuseoModerno w-screen h-100">
	...
	<span class="flex flex-row justify-center my-12 gap-28">
		...
		<a href="https://www.facebook.com/profile.php?id=100004633398479" target="_blank">
			<Icon icon="el:facebook" color="white" class="w-20 h-20" />
		</a>
		<a href="https://www.instagram.com/samithiwat/" target="_blank">
			<Icon icon="ant-design:instagram-filled" color="white" class="w-20 h-20" />
		</a>
	</span>
	<h5 class="text-white text-lg">Follow me</h5>
</div>
